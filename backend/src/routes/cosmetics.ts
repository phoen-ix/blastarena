...
router.get('/cosmetics/mine', authMiddleware, async (req, res, next) => {
  try {
...
router.get('/cosmetics/equipped', authMiddleware, async (req, res, next) => {
  try {
...
router.put('/cosmetics/equip', authMiddleware, validate(equipSchema), async (req, res, next) => {
  try {
...
router.get('/achievements/mine', authMiddleware, async (req, res, next) => {
  try {
